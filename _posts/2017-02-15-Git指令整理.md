...
# GitHub创建仓库提示代码
	...
	git commit -m "first commit" 添加日志
	
	git remote add origin git@github.com:qiubaiying/项目名.git
	
	git push origin master 强推
...
![](https://cdn.jsdelivr.net/gh/AngleLwt/images/image/21988850-932ebadf0a8e75a4.png)

点击test按钮如果出现 Git executed successfully 对话框说明配置成功，同时对话框会显示你安装的git版本号；如下图所示

![](https://cdn.jsdelivr.net/gh/AngleLwt/images/image/21988850-989e3207b870fe7a.png)

打开如下路径File->Settings->Version Control(展开)->GitHub，如下图所示

![](https://cdn.jsdelivr.net/gh/AngleLwt/images/image/21988850-485a82f167603e3c.png)
...
![](https://cdn.jsdelivr.net/gh/AngleLwt/images/image/21988850-484ac088d6d18620 (1).png)

如果你是第一次提交该项目会出现如下对话框，提示你这是一个新的存储库（repo），可以自定义repo的名字，和添加描述。

![](https://cdn.jsdelivr.net/gh/AngleLwt/images/image/21988850-bd2b5bd2809fae1e.png)

填写完毕点击share按钮如果你的工程没有问题会出现如下界

![](https://cdn.jsdelivr.net/gh/AngleLwt/images/image/21988850-da4838c215914598.png)
